...
func testRuntimeOptions() cord.RuntimeOptions {
	return cord.RuntimeOptions{
		Concurrency:       1,
...
func newRuntimeWithOptions(t *testing.T, database *sql.DB, options cord.RuntimeOptions) *cord.Cord {
	t.Helper()

	runtime, err := cord.NewWithOptions(database, options)
